...
# Create destination folder, define origin datasets and iterate through
# files to copy them into new directory. Print image counts to validate.
...
for i in range(len(sequence_1_images)):
    ...
    (T, binary_image) = cv.threshold(difference_image, 40, 255, cv.THRESH_BINARY)
    ...
    erosion_image = cv.erode(binary_image, kernel, iterations = 1)
    ...
    # Calculate mean centroid and draw as big circle.
...
- What to do about correct sequence order?
- Task 4
'''